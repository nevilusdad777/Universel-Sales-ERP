    ...
    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] focus:ring-1 focus:ring-[#004ac6] ${errors.name ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] focus:ring-1 focus:ring-[#004ac6] ${errors.companyName ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] focus:ring-1 focus:ring-[#004ac6] ${errors.email ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] focus:ring-1 focus:ring-[#004ac6] ${errors.phoneNumber ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        />
      ...
      <div>
        ...
        <select
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] ${errors.customerType ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        >
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] ${errors.creditLimit ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        />
      ...
      <div className="sm:col-span-2">
        ...
        <input
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] ${errors.address ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] ${errors.city ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        />
      ...
      <div>
        ...
        <select
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] ${errors.state ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        >
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 bg-white border rounded text-sm text-[#191b23] focus:outline-none focus:border-[#004ac6] ${errors.pincode ? 'border-[#ba1a1a]' : 'border-[#c3c6d7]'}`}
        />
...
const Customers = () => {
  ...
  const handleSubmit = async (data) => {
    ...
    try {
      const sanitizedData = {
        ...data,
        creditLimit: data.creditLimit === '' || data.creditLimit === null || isNaN(Number(data.creditLimit))
          ? 0
  ...
  return (
    <main className="flex-1 p-4 md:p-8 bg-[#faf8ff] overflow-y-auto">
      <ConfirmDialog
        ...
        message="Are you sure you want to delete this customer? Customer cannot be deleted if active Quotations or Orders exist."
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-[30px] font-semibold text-[#191b23] m-0 leading-tight">Customers</h1>
      ...
      <div className="bg-white rounded border border-[#e2e8f0] shadow-sm flex flex-col">
        ...
        {/* Toolbar */}
        <div className="p-4 border-b border-[#e2e8f0] flex flex-col sm:flex-row justify-between gap-3 items-start sm:items-center bg-white">
            ...
            <table className="w-full text-left border-collapse min-w-[900px]">
              <thead>
                <tr className="bg-[#f1f5f9] border-b border-[#e2e8f0]">
                  <th className="py-3 px-4 text-xs font-semibold text-[#434655] uppercase tracking-wider">Name</th>
                  <th className="py-3 px-4 text-xs font-semibold text-[#434655] uppercase tracking-wider">Company</th>
                  <th className="py-3 px-4 text-xs font-semibold text-[#434655] uppercase tracking-wider">Contact</th>
                  <th className="py-3 px-4 text-xs font-semibold text-[#434655] uppercase tracking-wider">Location</th>
                  <th className="py-3 px-4 text-xs font-semibold text-[#434655] uppercase tracking-wider text-right">Credit Limit</th>
                  <th className="py-3 px-4 text-xs font-semibold text-[#434655] uppercase tracking-wider text-right">Outstanding</th>
                  <th className="py-3 px-4 text-xs font-semibold text-[#434655] uppercase tracking-wider">Status</th>
              ...
              <tbody className="text-sm text-[#191b23] bg-white divide-y divide-[#f1f5f9]">
                {customers.map((c) => (
                  <tr key={c.id} className="hover:bg-slate-50 transition-colors h-14">
                    ...
                    <td className="py-2 px-4 text-[#191b23]">{c.companyName}</td>
                    <td className="py-2 px-4">
                      <div className="flex flex-col">
                        <span>{c.email}</span>
                        <span className="text-[#737686] text-xs">{c.phoneNumber}</span>
                      </div>
                    </td>
                    ...
                    <td className="py-2 px-4 text-right font-mono">
                      <span className={c.outstandingAmount > 0 ? 'text-[#ba1a1a] font-semibold' : 'text-[#191b23]'}>
                        ₹{(c.outstandingAmount || 0).toLocaleString()}
                      </span>
                    </td>
                    <td className="py-2 px-4">
          ...
          <div className="p-3 px-4 border-t border-[#e2e8f0] flex items-center justify-between bg-white text-sm text-[#434655]">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="px-3 py-1 border border-[#e2e8f0] rounded text-sm hover:bg-[#f3f3fe] transition-colors disabled:opacity-40 cursor-pointer"
              >
                Previous
              </button>
              <button
